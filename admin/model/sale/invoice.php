...
class ModelSaleInvoice extends Model {
	public function addInvoice($data) {
		...
		$sql = "INSERT INTO `" . DB_PREFIX . "invoice` SET 
			`invoice_prefix` = '" . $this->db->escape($invoice_prefix) . "',
			 ...
			 `bank_index` = '" . $this->db->escape((string)(isset($data['bank_index']) ? $data['bank_index'] : '')) . "',
	...
	public function createNegativeInvoice($invoice_id) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "invoice SET
			...
			bank_index = '" . $this->db->escape($invoice['bank_index']) . "',
			...
			simplified = '" . (int)$invoice['simplified'] . "',
	...
	public function getInvoice($invoice_id) {
		...
		if ($invoice_query->num_rows) {
			...
			return array(
				...
				'bank_index'              => $invoice_query->row['bank_index'],
				...
				'simplified'              => $invoice_query->row['simplified'],
