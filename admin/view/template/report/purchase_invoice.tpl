...
function filter() {
	location = 'index.php?route=report/purchase_invoice&token=<?php echo $token; ?>' + buildFilterParams();
}
function exportExcel() {
	location = 'index.php?route=report/purchase_invoice/export&token=<?php echo $token; ?>' + buildFilterParams();
}
//--></script>
