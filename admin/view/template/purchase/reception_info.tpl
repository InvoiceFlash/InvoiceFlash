...
<div class="panel panel-default">
	<div class="panel-heading clearfix">
		...
		<div class="pull-right">
			...
			<?php if ($invoice_no) { ?>
			<a class="btn btn-success" href="<?php echo $generate; ?>"><i class="fa fa-file-invoice"></i><span class="hidden-xs"> <?php echo $button_generate; ?></span></a>
			<?php } else { ?>
			<a class="btn btn-success" href="<?php echo $generate; ?>" onclick="return confirm(text_confirm);"><i class="fa fa-exchange-alt"></i><span class="hidden-xs"> <?php echo $button_generate; ?></span></a>
			<?php } ?>
	...
	<div class="panel-body">
		<div class="tabbable">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active" href="#tab-reception" data-bs-toggle="tab"><?php echo $tab_reception; ?></a></li>
			...
			<div class="tab-content mt-2">
				<div id="tab-reception" class="tab-pane active">
					<table class="table table-bordered table-striped table-hover info-page">
						<tr>
							<td class="col-sm-3"><?php echo $text_reception_id; ?></td>
							<td>#<?php echo $reception_id; ?></td>
						</tr>
						<?php if ($supplier_delivery_no) { ?>
						<tr>
							<td><?php echo $text_supplier_delivery_no; ?></td>
							<td><?php echo $supplier_delivery_no; ?></td>
						</tr>
						<?php } ?>
						<tr>
						...
						<tr>
							<td><?php echo $text_reception_status; ?></td>
							<td id="reception-status"><?php echo $reception_status; ?></td>
						</tr>
						<?php if ($comment) { ?>
						<tr>
				...
				<div id="tab-history" class="tab-pane">
					<div id="history" data-href="index.php?route=purchase/reception/history&token=<?php echo $token; ?>&reception_id=<?php echo $reception_id; ?>"></div>
					<div class="form-horizontal">
						<div class="form-group row">
							<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_reception_status; ?></label>
							<div class="col-sm-6">
								<select name="reception_status_id" class="form-control">
									<?php foreach ($reception_statuses as $status) { ?>
									<?php if ($status['reception_status_id'] == $reception_status_id) { ?>
									<option value="<?php echo $status['reception_status_id']; ?>" selected=""><?php echo $status['name']; ?></option>
									<?php } else { ?>
									<option value="<?php echo $status['reception_status_id']; ?>"><?php echo $status['name']; ?></option>
									<?php } ?>
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-group row">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-history" data-action="reception" data-target="purchase" data-id="<?php echo $reception_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?php echo $button_add_history; ?></button>
							</div>
						</div>
					</div>
				</div>
