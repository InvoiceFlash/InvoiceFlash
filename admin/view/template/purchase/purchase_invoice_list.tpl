...
<div class="panel panel-default">
	<div class="panel-heading clearfix">
		...
		<div class="pull-right">
			<button type="button" onclick="piOpenPrintModal('');" class="btn btn-default btn-spacer"><i class="fa fa-eye"></i><span class="hidden-xs"> View</span></button>
			<button type="button" onclick="piOpenPrintModal('pdf');" class="btn btn-default btn-spacer"><i class="fa fa-file-pdf"></i><span class="hidden-xs"> PDF</span></button>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?php echo $sort_company; ?>"><?php echo $column_supplier; echo ($sort == 'company') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					<tr id="filter" class="info">
						<td class="text-center"><a class="btn btn-default btn-block" href="index.php?route=purchase/invoice&token=<?php echo $token; ?>" rel="tooltip" title="Reset"><i class="fa fa-power-off fa-fw"></i></a></td>
...
<script>
function piOpenPrintModal(format) {
