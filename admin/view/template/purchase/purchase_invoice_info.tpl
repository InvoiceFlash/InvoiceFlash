...
<div class="panel panel-default">
	<div class="panel-heading clearfix">
		...
		<div class="pull-right">
			...
			<?php if ($has_original_document) { ?>
			<a class="btn btn-default" href="<?php echo $original_document; ?>" target="_blank"><i class="fa fa-paperclip"></i><span class="hidden-xs"> <?php echo $button_original_document; ?></span></a>
			<?php } ?>
			...
			<button class="btn btn-default" data-bs-toggle="modal" data-bs-target="#PrintModal" data-keyboard="true"><i class="fa fa-print"></i><span class="hidden-xs"> View</span></button>
		...
		<div class="tabbable">
			...
			<div class="tab-content mt-2">
				...
				<div id="tab-history" class="tab-pane">
					<div id="history" data-href="index.php?route=purchase/invoice/history&token=<?php echo $token; ?>&invoice_id=<?php echo $invoice_id; ?>"></div>
					<div class="form-horizontal">
						...
						<div class="form-group row">
							<div class="col-sm-6">
								<button type="button" id="button-history" data-action="invoice" data-target="purchase" data-id="<?php echo $invoice_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?php echo $button_add_history; ?></button>
							</div>
						</div>
					</div>
				</div>
