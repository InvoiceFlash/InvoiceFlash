...
<div class="panel panel-default">
	<?php $fa = 'file-invoice-dollar'; include(DIR_TEMPLATE . 'common/template-title-form.tpl'); ?>
	<div class="panel-body">
		...
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" name="accounts" value="<?php echo $accounts_field; ?>" class="form-control" placeholder="4770000021 &oacute; C03+C06+C09 &oacute; C03/0.04">
					<div class="help-block"><?php echo $help_accounts; ?></div>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					<div class="help-block"><?php echo $help_level; ?></div>
				</div>
			</div>
			<div class="form-group row">
