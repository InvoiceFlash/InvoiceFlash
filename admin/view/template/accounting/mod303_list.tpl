...
<div class="panel panel-default">
	<?php $fa = 'file-invoice-dollar'; include(DIR_TEMPLATE . 'common/template-title-list.tpl'); ?>
				...
				<tbody>
					...
					<tr>
						<td class="text-center"><?php if ($account['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $account['ctab10_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $account['ctab10_id']; ?>">
							<?php } ?></td>
