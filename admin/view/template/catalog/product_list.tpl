...
<div class="panel panel-default">
	<div class="panel-heading clearfix">
		...
		<div class="pull-right">
			<button type="submit" form="form" formaction="<?php echo $export; ?>" id="btn-export" class="btn btn-success btn-spacer"><i class="fa fa-file-excel"></i><span class="hidden-xs"> <?php echo $button_export; ?></span></button>
			<button class="btn btn-success btn-spacer" onClick="validate();"><i class="fa fa-copy"></i><span class="hidden-xs"> <?php echo $button_copy; ?></span></button>
