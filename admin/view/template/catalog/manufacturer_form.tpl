		...
		<div class="tab-content">
			<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<div class="form-group">
					<label class="control-label col-sm-2" for="name"><b class="required">*</b> <?php echo $entry_name; ?></label>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="keyword"><?php echo $entry_keyword; ?></label>
					<div class="control-field col-sm-4">
						<input type="text" name="keyword" value="<?php echo $keyword; ?>" class="form-control" id="keyword" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="sort_order"><?php echo $entry_sort_order; ?></label>
					<div class="control-field col-sm-4">
