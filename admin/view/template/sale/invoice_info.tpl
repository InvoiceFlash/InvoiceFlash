	...
	<div class="panel-body">
		<div class="tabbable">
			<ul class="nav nav-tabs"><li class="nav-item"><a class="nav-link active"href="#tab-invoice" data-toggle="tab"><?php echo $tab_invoice; ?></a></li><li class="nav-item"><a class="nav-link" href="#tab-payment" data-toggle="tab"><?php echo $tab_payment; ?></a></li>
				...
				<?php } ?>
				<li class="nav-item"><a class="nav-link" href="#tab-product" data-toggle="tab"><?php echo $tab_product; ?></a></li><li class="nav-item"><a class="nav-link" href="#tab-history" data-toggle="tab"><?php echo $tab_history; ?></a></li><li class="nav-item"><a class="nav-link" href="#tab-receipts" data-toggle="tab"><?php echo $tab_receipts; ?></a></li><li class="nav-item"><a class="nav-link" href="#tab-aeat" data-toggle="tab"><?php echo $tab_aeat; ?></a></li>
			</ul>
