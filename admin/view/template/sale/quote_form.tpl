					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="control-field col-sm-8">
										<input type="text" name="product" value="" id="quote-product" class="form-control" autocomplete="off">
						...
						<div class="modal-footer">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-quote-product" class="btn btn-info pull-right" data-bs-dismiss="modal">
...
$('#ProductModal').on('hidden.bs.modal', function () {
    $(this).find("#quote-product").val('').end();
