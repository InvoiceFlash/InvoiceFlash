...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active" href="#tab-customer" data-toggle="tab"><?php echo $tab_customer; ?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab-payment" data-toggle="tab"><?php echo $tab_payment; ?></a></li>
			...
			<li class="nav-item"><a class="nav-link" href="#tab-total" data-toggle="tab"><?php echo $tab_total; ?></a></li>
		</ul>
		<form class="form-horizontal" onsubmit="return validateForm()" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div class="tab-content">
					...
					<tbody id="product">
						...
						<tr id="product-row<?php echo $product_row; ?>">
							...
							<td class="text-right"><?php echo $quote_product['total']; ?>
								...
								<input type="hidden" name="quote_product[<?php echo $product_row; ?>][tax]" value="<?php echo $quote_product['tax']; ?>">
								<input type="hidden" name="quote_product[<?php echo $product_row; ?>][reward]" value="<?php echo $quote_product['reward']; ?>"></td>
						</tr>
						<?php $product_row++; ?>
						<?php } ?>
						<?php } else { ?>
			...
			<div id="tab-total" class="tab-pane">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody id="total">
						<?php $total_row = 0; ?>
						<?php if ($quote_products || $quote_totals) { ?>
						<?php foreach ($quote_products as $quote_product) { ?>
						<tr>
							...
							<?php foreach ($quote_product['option'] as $option) { ?>
								<div class="help"><?php echo $option['name']; ?>: <?php echo $option['value']; ?></div>
							<?php } ?></td>
							<td><?php echo $quote_product['model']; ?></td>
							<td class="text-right"><?php echo $quote_product['quantity']; ?></td>
							<td class="text-right"><?php echo $quote_product['price']; ?></td>
							<td class="text-right"><?php echo $quote_product['total']; ?></td>
						</tr>
						<?php } ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_quote_status; ?></label>
						<div class="control-field col-sm-4">
							<select name="quote_status_id" class="form-control">
								<?php foreach ($quote_statuses as $quote_status) { ?>
								<?php if ($quote_status['order_status_id'] == $quote_status_id) { ?>
