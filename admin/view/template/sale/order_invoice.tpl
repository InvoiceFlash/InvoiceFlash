...
<?php foreach ($orders as $order) { ?>
	<div class="store_logo">
		<div class="logo">
			<img src="<?php echo '../image/' . $logo; ?>" title="<?php echo $order['store_name']; ?>" />
			<span class="title"><?php echo $text_order; ?></span>
		</div>
	</div>
	<table class="table table-bordered">
		<tr>
			<td width="50%"><b><?php echo $order['store_name']; ?></b><br>
	...
	<table class="table table-bordered">
		...
		<tr>
			<td><?php if ($order['payment_company']) { ?>
				...
				<?php } ?></td>
			<td><?php if ($order['shipping_company']) { ?>
					<b><?php echo $order['shipping_company']; ?></b><br/>
					<?php } ?>
