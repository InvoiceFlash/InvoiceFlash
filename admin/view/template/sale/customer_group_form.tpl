...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_company_id_display; ?></label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_company_id_required; ?></label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_tax_id_display; ?></label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_tax_id_required; ?></label>
				<div class="col-sm-6">
