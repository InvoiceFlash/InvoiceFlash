...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="tabbable">
			<ul class="nav nav-tabs"><li class="nav-item"><a class="nav-link active"href="#tab-order" data-bs-toggle="tab"><?php echo $tab_order; ?></a></li><li class="nav-item"><a class="nav-link" href="#tab-payment" data-bs-toggle="tab"><?php echo $tab_payment; ?></a></li>
			...
			<div class="tab-content mt-2">
				<div id="tab-order" class="tab-pane active">
					<table class="table table-bordered table-striped table-hover info-page">
						<tr>
							<td class="col-sm-3"><?php echo $text_order_id; ?></td>
							<td>#<?php echo $order_id; ?></td>
						</tr>
						<tr>
							<td><?php echo $text_generate_delivery; ?></td>
						...
						<tr>
							...
							<td id="invoice-status"><?php echo $order_status; ?></td>
						</tr>
						<?php } ?>
						<?php if ($comment) { ?>
						<tr>
				...
				<div id="tab-history" class="tab-pane">
					<div id="history" data-href="index.php?route=sale/order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>"></div>
					<div class="form-horizontal">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<select name="order_status_id" class="form-control">
									...
									<option value="<?php echo $order_statuses['order_status_id']; ?>" selected=""><?php echo $order_statuses['name']; ?></option>
									<?php } else { ?>
						...
						<div class="form-group row">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-history" data-action="order" data-target="sale" data-id="<?php echo $order_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?php echo $button_add_history; ?></button>
							</div>
						</div>
					</div>
				</div>
