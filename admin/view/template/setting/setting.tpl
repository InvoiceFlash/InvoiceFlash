...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item"><a class="nav-link" href="#tab-accounting" data-toggle="tab"><?php echo $tab_accounting; ?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab-hacienda" data-toggle="tab"><?php echo $tab_hacienda; ?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab-fraud" data-toggle="tab"><?php echo $tab_fraud; ?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab-server" data-toggle="tab"><?php echo $tab_server; ?></a></li>
			<li class="nav-item"><a class="nav-link" href="#tab-ia" data-toggle="tab"><?php echo $tab_ia; ?></a></li></ul>
