		...
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="tab-content">
				...
				<div id="tab-local" class="tab-pane">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_admin_language; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_currency_auto; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_length_class; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_weight_class; ?></label>
						<div class="control-field col-sm-4">
					...
					<div>
						...
						<div class="tab-content">
							<div id="tab-items" class="tab-pane">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><b class="required">*</b> <?php echo $entry_admin_limit; ?></label>
									<div class="control-field col-sm-4">
										<input type="text" name="config_admin_limit" value="<?php echo $config_admin_limit; ?>" class="form-control">
										<?php if ($error_admin_limit) { ?>
											<div class="help-block error"><?php echo $error_admin_limit; ?></div>
										<?php } ?>
									</div>
								</div>
							</div>
							<div id="tab-product" class="tab-pane">
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_product_count; ?></label>
									<div class="control-field col-sm-4">
							...
							<div id="tab-voucher" class="tab-pane">
								<div class="form-group">
									<label class="control-label col-sm-2"><b class="required">*</b> <?php echo $entry_voucher_min; ?></label>
									<div class="control-field col-sm-4">
										<input type="text" name="config_voucher_min" value="<?php echo $config_voucher_min; ?>" class="form-control">
										<?php if ($error_voucher_min) { ?>
											<div class="help-block error"><?php echo $error_voucher_min; ?></div>
										<?php } ?>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2"><b class="required">*</b> <?php echo $entry_voucher_max; ?></label>
									<div class="control-field col-sm-4">
										<input type="text" name="config_voucher_max" value="<?php echo $config_voucher_max; ?>" class="form-control">
										<?php if ($error_voucher_max) { ?>
											<div class="help-block error"><?php echo $error_voucher_max; ?></div>
										<?php } ?>
									</div>
								</div>
							</div>
							<div id="tab-tax" class="tab-pane">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_vat; ?></label>
									<div class="control-field col-sm-4">
										<?php if ($config_vat) { ?>
							...
							<div id="tab-account" class="tab-pane">
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_customer_online; ?></label>
									<div class="control-field col-sm-4">
							...
							<div id="tab-checkout" class="tab-pane">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_order_edit; ?></label>
									<div class="control-field col-sm-4">
										<input type="text" name="config_order_edit" value="<?php echo $config_order_edit; ?>" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_invoice_prefix; ?></label>
									<div class="control-field col-sm-4">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_complete_status; ?></label>
									<div class="control-field col-sm-4">
							...
							<div id="tab-stock" class="tab-pane">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_stock_warning; ?></label>
									<div class="control-field col-sm-4">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_stock_status; ?></label>
									<div class="control-field col-sm-4">
							...
							<div id="tab-affiliate" class="tab-pane">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_commission; ?></label>
									<div class="control-field col-sm-4">
							...
							<div id="tab-return" class="tab-pane">
								<div class="form-group">
									<label class="control-label col-sm-2"><?php echo $entry_return; ?></label>
									<div class="control-field col-sm-4">
				...
				<div id="tab-ftp" class="tab-pane">
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_host; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_ftp_host" value="<?php echo $config_ftp_host; ?>" class="form-control">
							<?php if ($error_ftp_host) { ?>
							<div class="help-block error"><?php echo $error_ftp_host; ?></div>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_port; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_ftp_port" value="<?php echo $config_ftp_port; ?>" class="form-control">
							<?php if ($error_ftp_port) { ?>
							<div class="help-block error"><?php echo $error_ftp_port; ?></div>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_username; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_ftp_username" value="<?php echo $config_ftp_username; ?>" class="form-control">
							<?php if ($error_ftp_username) { ?>
							<div class="help-block error"><?php echo $error_ftp_username; ?></div>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_password; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_ftp_password" value="<?php echo $config_ftp_password; ?>" class="form-control">
							<?php if ($error_ftp_password) { ?>
							<div class="help-block error"><?php echo $error_ftp_password; ?></div>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_root; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_ftp_root" value="<?php echo $config_ftp_root; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_ftp_status; ?></label>
						<div class="col-sm-6">
				...
				<div id="tab-mail" class="tab-pane">
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_mail_protocol; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_mail_parameter; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_mail_parameter" value="<?php echo $config_mail_parameter; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_smtp_host; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_smtp_host" id="host" value="<?php echo $config_smtp_host; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_smtp_username; ?></label>
						<div class="control-field col-sm-4">
						...
						<span class="input-group-btn">
							...
							<span style="color: red;" id="mcResponse"></span>
						</span>
						<!-- fin boton -->
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_smtp_password; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_smtp_password" id="pass" value="<?php echo $config_smtp_password; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_smtp_port; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_smtp_port" id="port" value="<?php echo $config_smtp_port; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_smtp_timeout; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_smtp_timeout" value="<?php echo $config_smtp_timeout; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_alert_mail; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_account_mail; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_alert_emails; ?></label>
						<div class="control-field col-sm-4">
				...
				<div id="tab-payroll" class="tab-pane">
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_accounting_period ?></label>
						<div class="control-field col-sm-4"><input type="text" name="accounting_period" value="<?php echo $accounting_period ?>" class="form-control"></div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_iban ?></label>
						<div class="control-field col-sm-4"><input type="text" name="iban" value="<?php echo $iban ?>" class="form-control"></div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_bic ?></label>
						<div class="control-field col-sm-4"><input type="text" name="bic" value="<?php echo $bic ?>" class="form-control"></div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_creditor_id ?></label>
						<div class="control-field col-sm-4"><input type="text" name="creditor_id" value="<?php echo $creditor_id ?>" class="form-control"></div>
					</div>
				</div>
				<div id="tab-fraud" class="tab-pane">
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_fraud_detection; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_fraud_key; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_fraud_key" value="<?php echo $config_fraud_key; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_fraud_score; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_fraud_score" value="<?php echo $config_fraud_score; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_fraud_status; ?></label>
						<div class="control-field col-sm-4">
				...
				<div id="tab-server" class="tab-pane">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_shared; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_robots; ?></label>
						<div class="control-field col-sm-4">
							<textarea name="config_robots" class="form-control" rows="3"><?php echo $config_robots; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_seo_url; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_encryption; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_encryption" value="<?php echo $config_encryption; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_compression; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_compression" value="<?php echo $config_compression; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_error_display; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_error_log; ?></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><b class="required">*</b> <?php echo $entry_error_filename; ?></label>
						<div class="control-field col-sm-4">
							<input type="text" name="config_error_filename" value="<?php echo $config_error_filename; ?>" class="form-control">
							<?php if ($error_error_filename) { ?>
								<div class="help-block error"><?php echo $error_error_filename; ?></div>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2"><?php echo $entry_google_analytics; ?></label>
						<div class="control-field col-sm-4">
