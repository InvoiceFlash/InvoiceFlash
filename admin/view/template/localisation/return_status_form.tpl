			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<?php foreach ($languages as $language) { ?>
						<div class="input-group"><input type="text" name="return_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($return_status[$language['language_id']]) ? $return_status[$language['language_id']]['name'] :''; ?>" class="form-control">
