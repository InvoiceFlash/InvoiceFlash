...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?php echo $entry_iso_code_2; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="iso_code_2" value="<?php echo $iso_code_2; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?php echo $entry_iso_code_3; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="iso_code_3" value="<?php echo $iso_code_3; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?php echo $entry_address_format; ?></label>
				<div class="control-field col-sm-8">
					<textarea name="address_format" class="form-control ckeditor" rows="8"><?php echo $address_format; ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?php echo $entry_postcode_required; ?></label>
				<div class="col-sm-4">
