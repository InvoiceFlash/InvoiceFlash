			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<?php foreach ($languages as $language) { ?>
						<div class="input-group"><input type="text" name="return_action[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($return_action[$language['language_id']]) ? $return_action[$language['language_id']]['name'] :''; ?>" class="form-control">
