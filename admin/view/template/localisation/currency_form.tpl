...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_symbol_left; ?></label>
				<div class="col-sm-6">
					<input type="text" name="symbol_left" value="<?php echo $symbol_left; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_symbol_right; ?></label>
				<div class="col-sm-6">
					<input type="text" name="symbol_right" value="<?php echo $symbol_right; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-form-label col-sm-10 col-md-2"><?php echo $entry_decimal_place; ?></label>
				<div class="col-sm-6">
