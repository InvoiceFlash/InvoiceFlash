...
$_['error_aeat_ca_bundle']                    = 'Warning: Could not verify the AEAT server SSL certificate because this server has no trusted CA certificate bundle configured. Contact your system administrator or hosting provider to configure one.';
$_['error_aeat_ca_bundle_not_found']           = 'Warning: The CA bundle path configured in Settings (Tax Office tab) does not exist.';
