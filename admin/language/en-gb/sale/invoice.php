...
$_['error_facturae_vat_id']                   = 'Warning: You must set the VAT-ID field in Settings before generating a Facturae invoice!';
$_['error_facturae_certificate']              = 'Warning: You must upload the digital certificate and set its password in the Payroll tab of Settings before generating a Facturae invoice!';
$_['error_facturae_seller_postcode']          = 'Warning: The store address in Settings must include a valid 5-digit postcode before generating a Facturae invoice!';
