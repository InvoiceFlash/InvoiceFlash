...
$_['entry_sales_order_prefix']      = '<a data-toggle="tooltip" title="Prefijo para los pedidos de venta (p.ej. ORD-2026-00)."><i class="fas fa-question-circle"></i></a> Sales Order Prefix:';
...
$_['text_ocr_title'] = 'OCR (Qwen2.5-VL 3B)';
$_['entry_ocr_ollama_url'] = 'Ollama URL for OCR:';
...
$_['entry_supplier_invoice_imap_host'] = 'IMAP server (host):';
$_['entry_supplier_invoice_imap_port'] = 'IMAP port:';
$_['entry_supplier_invoice_imap_ssl'] = 'Use SSL/TLS?';
$_['error_supplier_invoice_email'] = 'You must set an email in the Mail tab to import supplier invoices.';
$_['error_supplier_invoice_imap_host'] = 'You must set the IMAP server in the Mail tab to import supplier invoices.';
