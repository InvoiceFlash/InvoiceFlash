...
$_['entry_decimal_point']          = 'Decimal separator:';
$_['entry_thousand_point']         = 'Thousands separator:';
$_['error_decimal_point']          = 'Enter exactly one character.';
$_['error_thousand_point']         = 'Enter exactly one character, different from the decimal separator.';
...
$_['text_open_next_convert_tooltip']  = 'When you convert a single quote/order/delivery/draft to the next document in the chain (Quote&rarr;Order&rarr;Delivery&rarr;Invoice) from the list, if this option is set to Yes, the app automatically opens the newly created document in a new tab.';
...
$_['entry_product_vector_embeddings'] = 'Enable RAG';
$_['text_product_vector_embeddings_tooltip'] = 'If enabled (and an Ollama model with embedding support is available), any PDF attached to a product is automatically indexed into the vector database so the AI can look it up (RAG).';
...
$_['entry_sales_order_prefix']      = '<a data-toggle="tooltip" title="Prefix for sales orders (e.g. PED-2026-00)."><i class="fas fa-question-circle"></i></a> Sales Order Prefix:';
$_['entry_sales_delivery_prefix']   = '<a data-toggle="tooltip" title="Prefix for sales delivery notes (e.g. ALB-2026-00)."><i class="fas fa-question-circle"></i></a> Sales Delivery Prefix:';
...
$_['entry_invoice_prefix']         = '<a data-toggle="tooltip" title="Set the invoice prefix (e.g. INV-2019-00). Invoice ID\'s will start at 1 for each unique prefix"><i class="fas fa-question-circle"></i></a> Invoice Prefix:';
...
$_['error_conta_ventas_account']   = 'The sales accounting account must have %d digits!';
$_['error_conta_cliente_account']  = 'The customer accounting account must have %d digits!';
$_['error_conta_result_account']   = 'The result accounting account must have %d digits!';
$_['error_conta_compras_account']  = 'The purchases accounting account must have %d digits!';
$_['error_conta_proveedor_account'] = 'The supplier accounting account must have %d digits!';
$_['error_conta_iva_repercutido_account'] = 'The output VAT accounting account must have %d digits!';
$_['error_conta_iva_soportado_account']   = 'The input VAT accounting account must have %d digits!';
...
$_['tab_recepciones']	 = 'Receiving';
$_['text_recepciones_ai_note'] = 'This will only activate if AI is configured.';
$_['tab_ia']	 = 'AI';
...
$_['entry_accounting_period_next_fiscal_year'] = 'Entries after that date will go to fiscal year:';
$_['entry_iban'] = 'IBAN:';
$_['entry_bic'] = 'BIC:';
...
$_['text_creditor_id_tooltip'] = 'Your company\'s SEPA creditor identifier (assigned by your bank), used to generate the SEPA direct debit mandate printed from the customer page. Not needed if you don\'t collect payments via SEPA direct debit.';
$_['entry_conta_enabled'] = 'Enable accounting:';
$_['entry_conta_ventas_account'] = 'Sales accounting account:';
$_['entry_conta_cliente_account'] = 'Customer accounting account (default):';
$_['entry_conta_result_account'] = 'Result accounting account (129):';
$_['entry_conta_compras_account'] = 'Purchases accounting account (600):';
$_['entry_conta_proveedor_account'] = 'Supplier accounting account (default, 400):';
$_['entry_conta_iva_repercutido_account'] = 'Output VAT accounting account (477):';
$_['entry_conta_iva_soportado_account'] = 'Input VAT accounting account (472):';
...
$_['entry_ollama_url'] = 'Ollama URL:';
$_['button_ai_test'] = 'Test';
$_['text_ai_test_ok'] = 'Ok';
$_['text_ai_test_no_response'] = 'No response';
$_['entry_import_supplier_invoices'] = 'Import supplier invoices:';
$_['text_import_supplier_invoices_tooltip'] = 'If AI is enabled, this automatically integrates supplier invoices. You need to have the email configured.';
$_['entry_supplier_invoice_email'] = 'Supplier invoices receiving email:';
$_['entry_supplier_invoice_email_password'] = 'Password for the invoice suppliers email:';
$_['entry_supplier_invoice_pop_host'] = 'POP3 server (host):';
$_['entry_supplier_invoice_pop_port'] = 'POP3 port:';
$_['entry_supplier_invoice_pop_ssl'] = 'Use SSL/TLS?';
