...
$_['text_success_flash_gestion'] = 'Success: %d products, %d customers, %d contacts and %d suppliers imported!';
$_['text_flash_gestion_help'] = 'Path, on this same server, to the FLASH GESTION data folder (must contain ttab22.dbf, ttab4.dbf and/or ttab14.dbf depending on what you select). Choose what to import. If you enter a Company Code, it filters Customers (ttab11.dbf) and Products (confent.dbf + ttab32.dbf); Suppliers are currently imported without filtering.';
