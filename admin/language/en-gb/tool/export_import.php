...
$_['help_notes']                                        = '<b>The Export/Import Tool is designed to work with the default Opencart Edition files only.</b><br /><br />If you are using third party Category, Product, Options, Specials, Discounts, Rewards, Attributes or Filters extensions, under your administration, who are modifying the default files, then unpredictable results may happen during Export and Import.<br /><br />If you have a very large number of Products in your store, and you are experiencing server memory issues, please use the range filters.<br /><br /><br />';
...
// Version
$_['export_import_description']                         = '<b>Export / Import</b> is a spreadsheet importer-exporter for Opencart Edition, based on the original <b>Export/Import Tool</b> by JNeuhoff, and integrating the latest <b>PHPExcel</b> Core Files!';
$_['export_import_version']                             = '1.5.6.5 - OpenCart Edition';
$_['export_import_author']                              = '';
$_['export_import_support']                             = '';
$_['export_import_license']                             = '';
$_['export_tool_version']                               = '';
$_['export_tool_author']                                = '';
