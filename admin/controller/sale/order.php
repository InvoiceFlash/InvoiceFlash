...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['sendEmail'] = $this->url->link('sale/order/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'] . '&format=email', 'SSL');
			//end Add
			...
			$this->data['cancel'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . $url, 'SSL');
			$this->data['view_delivery'] = $this->url->link('sale/delivery/info', 'token=' . $this->session->data['token'] .  '&delivery_id=' . $order_info['invoice_no']);
			$this->data['order_id'] = $this->request->get['order_id'];
	...
	// public function createDelivery() {
		...
		// } elseif (isset($this->request->get['order_id'])) {
			...
			// $invoice_no = $this->model_sale_order->createDelivery($this->request->get['order_id']);
	...
	public function invoice() {
		...
		if ($lcFormat=='pdf') {
			...
			$lcFile = DIR_DOWNLOAD . 'order_' . $order_id . '.pdf';
