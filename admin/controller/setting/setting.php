...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['product_vector_embeddings'])) {
		...
		//Button test
		$this->data['testEmail'] = $this->url->link('setting/setting/testEmail', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['config_product_vector_embeddings'])) {
			$this->data['config_product_vector_embeddings'] = $this->request->post['config_product_vector_embeddings'];
		} else {
			$this->data['config_product_vector_embeddings'] = $this->config->get('config_product_vector_embeddings');
		}
		...
		if (isset($this->request->post['creditor_id'])) {
			$this->data['creditor_id'] = $this->request->post['creditor_id'];
		} else {
	...
	protected function validate() {
		...
		if (!empty($this->request->post['config_product_vector_embeddings']) && empty($this->request->post['config_ai_enabled'])) {
			$this->error['product_vector_embeddings'] = $this->language->get('error_product_vector_embeddings');
	...
	public function testEmail()	{
		...
		$mail = new Mail();
        $mail->protocol = $_POST['protocol'];
        $mail->hostname = $_POST['host'];
        $mail->username = $_POST['usermame'];
