...
// ====================================================================================================================
	...
	public static function unichr($c, $unicode=true) {
		// PHP 8's chr() requires an int and no longer silently casts a
		// non-numeric string (e.g. '') to 0 like PHP 5/7 did; replicate
		// that old behaviour explicitly so callers passing placeholder
		// values (see TCPDF::__construct()'s warm-up call) keep working.
		$c = (int)$c;
		if (!$unicode) {
			return chr($c);
		} elseif ($c <= 0x7F) {
