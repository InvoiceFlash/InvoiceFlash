...
class ControllerStep3 extends Controller {
	...
	public function index() {		
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_INVOICEFLASH . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_INVOICEFLASH . '\');' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_INVOICEFLASH . 'catalog/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_INVOICEFLASH. 'system/\');' . "\n";
			$output .= 'define(\'DIR_DATABASE\', \'' . DIR_INVOICEFLASH . 'system/database/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_INVOICEFLASH . 'catalog/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_INVOICEFLASH . 'catalog/view/theme/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_INVOICEFLASH . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_INVOICEFLASH . 'image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_INVOICEFLASH . 'system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_INVOICEFLASH . 'download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_INVOICEFLASH . 'system/logs/\');' . "\n\n";
			...
			$file = fopen(DIR_INVOICEFLASH . 'config.php', 'w');
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_INVOICEFLASH . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_INVOICEFLASH . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_INVOICEFLASH . 'admin/\');' . "\n";
			$output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_INVOICEFLASH . '\');' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_INVOICEFLASH . 'admin/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_INVOICEFLASH . 'system/\');' . "\n";
			$output .= 'define(\'DIR_DATABASE\', \'' . DIR_INVOICEFLASH . 'system/database/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_INVOICEFLASH . 'admin/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_INVOICEFLASH . 'admin/view/template/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_INVOICEFLASH . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_INVOICEFLASH . 'image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_INVOICEFLASH . 'system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_INVOICEFLASH . 'download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_INVOICEFLASH . 'system/logs/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG\', \'' . DIR_INVOICEFLASH . 'catalog/\');' . "\n\n";
			...
			$file = fopen(DIR_INVOICEFLASH . 'admin/config.php', 'w');
	...
	private function validate() {
		...
		if (!is_writable(DIR_INVOICEFLASH . 'config.php')) {
			$this->error['warning'] = 'Error: Could not write to config.php please check you have set the correct permissions on: ' . DIR_INVOICEFLASH . 'config.php!';
		}

		if (!is_writable(DIR_INVOICEFLASH . 'admin/config.php')) {
			$this->error['warning'] = 'Error: Could not write to config.php please check you have set the correct permissions on: ' . DIR_INVOICEFLASH . 'admin/config.php!';
		}	
