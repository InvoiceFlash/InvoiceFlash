...
class ModelUpgrade extends Model {
	public function mysql() {
		...
		// Upgrade script to upgrade invoiceflash to the latest version. 
		...
		foreach($lines as $line) {
			// Set any prefix
			$line = str_replace("CREATE TABLE `if_", "CREATE TABLE `" . DB_PREFIX, $line);
		...
		$this->db = new DB(DB_DRIVER, DB_HOSTNAME, DB_USERNAME, DB_PASSWORD, DB_DATABASE, defined('DB_PORT') ? (int)DB_PORT : 3306);
