...
[![InvoiceFlash](https://img.shields.io/badge/InvoiceFlash-0.0.8-blue.svg)](https://github.com/InvoiceFlash/InvoiceFlash/tree/InvoiceFlash-0.0.8)
...
### 0.0.9 
- [x] Import products, customer, suppliers from *.xlsx
- [x] Export payroll SAGE/ContaSol
- [x] MCP Server
- [x] Languaje Spanish
